...
def show_table_structure(conn):
    try:
        with conn:
            ...
            # PRAGMA é uma instrução SQL que retorna informações sobre o banco de dados que utiliza mais de uma tabela
...
# Função principal para referenciar o caminho padrão e criar o banco de dados
def main():
